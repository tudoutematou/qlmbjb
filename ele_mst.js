...
async function _0x2928b2(_0x383f4c, _0xcca1bd) {
  ...
  const _0xe48caa = md5(_0x322f91 + '&' + _0x5b0fb1 + '&' + _0x41c3bc + '&' + JSON["stringify"](_0xcca1bd));
  const _0x109901 = {
...
async function _0x547a04(_0x141422) {
  ...
  for (let _0x181dc6 = 0; _0x181dc6 < _0x303b58["length"]; _0x181dc6++) {
    ...
    if (_0x192c5d === "hit" && _0xb0f88c === false) {
      _0x7a0f55 = _0x53c01c;
    } else if (_0x192c5d === "customer" && _0xb0f88c === false) {
      _0x1a93fe = _0x53c01c;
    } else if (_0x192c5d === "makeDishes" && _0xb0f88c === false) {
      _0x1dd6da = _0x53c01c;
    } else if (_0x192c5d === "score") {
      _0x49ce2c = !_0xb0f88c;
    }
  }
  let _0x115eea = false;
  while (!_0x1d9a36 && _0x24ee75 < 10) {
    ...
    try {
      ...
      if (_0x43d129 && _0x43d129["errorMessage"] === "没有对应关卡") {
        console["log"]("你已通关");
        break;
      } else if (_0x43d129["errorMessage"]) {
      ...
      for (let _0xe39dc = 0; _0xe39dc < _0x303b58["length"]; _0xe39dc++) {
        ...
        if (_0x172057 === "hit" && _0x288835 === false) {
          _0x7a0f55 = _0x56528e;
        } else if (_0x172057 === "customer" && _0x288835 === false) {
          _0x1a93fe = _0x56528e;
        } else if (_0x172057 === "makeDishes" && _0x288835 === false) {
          _0x1dd6da = _0x56528e;
        } else if (_0x172057 === "score" && !_0x115eea) {
          _0x49ce2c = !_0x288835;
        }
      }
