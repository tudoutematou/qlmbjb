...
async function query_task(_0x26773f) {
  ...
  const _0x1552ef = md5(_0x48c5a8 + '&' + _0x317943 + '&' + _0x2ae10d + '&' + JSON["stringify"](_0x460579));
  const _0x1da7ab = {
...
async function receive_yx_prize(_0x38f0c9, _0x905f0f, _0x7f9d6c, _0x277ffd, _0x22f890, _0x47d2ce, _0x8d06b4) {
  ...
  const _0x44ac5f = md5(_0x2593a6 + '&' + _0x530179 + '&' + _0x21479a + '&' + JSON["stringify"](_0x468b9a));
  const _0x42ef83 = {
...
async function queryTaskItem(_0x56553d, _0x99a344) {
  ...
  const _0x1b671e = md5(_0x34f618 + '&' + _0x4bf6b4 + '&' + _0x39fbd0 + '&' + JSON["stringify"](_0x99a344));
  const _0x4fccf2 = {
...
async function doReceivePrize(_0x4e4c2e, _0x3e743a, _0x3c8a89, _0xc8ed51 = 1) {
  ...
  } else if (_0x5246c8["indexOf"]("开启活动提醒") !== -1) {
...
async function doTask(_0x224b7b, _0x7d0fc8) {
  ...
  if (_0x31186a) {
    for (let _0x5ddfea = 0; _0x5ddfea < _0x31186a["length"]; _0x5ddfea++) {
      ...
      } else if (_0x5f12e5["status"] === "FINISH") {
...
async function commonRequest(_0x1be76f, _0x3f2c29, _0x34687d, _0x5098ec = "1608030065155%40eleme_android_11.1.38") {
  ...
  const _0x574efc = md5(_0x491d19 + '&' + _0x4b3c78 + '&' + _0x3a0486 + '&' + JSON["stringify"](_0x34687d));
  const _0x42ad07 = {
...
async function gameRequest(_0x252256, _0x230271) {
  ...
  const _0xeab8e5 = md5(_0x2bbbd4 + '&' + _0x34e415 + '&' + _0x576385 + '&' + JSON["stringify"](_0x230271));
  const _0x5a50b8 = {
