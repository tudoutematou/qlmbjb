...
async function pageview(_0x164b86, _0x35b682, _0x3b36a8, _0x41608a) {
  ...
  const _0x4f9868 = md5(_0x13235b + '&' + _0x9a78ab + '&' + _0x131df9 + '&' + JSON["stringify"](_0x2ee09b));
  const _0x4989d5 = {
...
async function gameRequest(_0x25b69b, _0x159f68) {
  ...
  const _0x5192de = md5(_0x4448ad + '&' + _0x36deb8 + '&' + _0x41fddb + '&' + JSON["stringify"](_0x159f68));
  const _0x554969 = {
...
async function receive_task(_0x1bf124, _0x59b767, _0x1ec318) {
  ...
  const _0x26f6c8 = md5(_0x186ef0 + '&' + _0x32102a + '&' + _0x481058 + '&' + JSON["stringify"](_0x12d4d2));
  const _0x6128de = {
...
async function query_task(_0x5b3ab4) {
  ...
  const _0x107418 = md5(_0x3ed92a + '&' + _0x5ce90d + '&' + _0x3dca72 + '&' + JSON["stringify"](_0x130006));
  const _0x39e4da = {
...
async function exchangeList(_0x323a0e) {
  ...
  const _0x1f7ca2 = md5(_0x3a9ed1 + '&' + _0x3f79fb + '&' + _0xa500e0 + '&' + JSON["stringify"](_0x4351c2));
  const _0x59047f = {
  ...
  while (!_0x16c2bb) {
    ...
    if (_0x2c7d31 && _0x2c7d31["amount"]) {
      ...
      if (_0x29a3ad && _0x29a3ad["amount"]) {
        ...
        _0x16c2bb = _0x29a3ad["msg"];
        if (!_0x16c2bb) console["log"]("当前金币", _0x29a3ad["num"]);
      }
      await wait(2);
      console["log"]("==============================");
    } else {
...
async function cgjl(_0xb8a48c, _0x18f2ff) {
  if (_0x18f2ff < 5) return;
  const _0x370128 = new Date()["getTime"]();
  var _0x1fe4c1 = 2;
  if (_0x18f2ff == 10) {
    _0x1fe4c1 = 3;
  } else if (_0x18f2ff == 20) {
    _0x1fe4c1 = 4;
  }
  const _0x27f4da = {
    "bizScene": "IDIOM",
...
async function exchange(_0x27459a, _0x21e9ce) {
  ...
  const _0x2a8f66 = md5(_0x4d850e + '&' + _0x3eb0c0 + '&' + _0x54c9e2 + '&' + JSON["stringify"](_0x48b343));
  const _0x3bfc5a = {
